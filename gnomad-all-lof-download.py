...
def download_gnomad_constraint_data():
    ...
    urls = {
        ...
        'v3.1.2': 'https://storage.googleapis.com/gnomad-public/release/3.1.2/constraint/gnomad.v3.1.2.constraint_metrics.tsv'
    }
...
def download_gnomad_vcf_header(chrom='1', version='3.1.2'):
    ...
    if version.startswith('3'):
        url = f"https://storage.googleapis.com/gnomad-public/release/{version}/vcf/genomes/gnomad.genomes.v{version}.sites.chr{chrom}.vcf.bgz"
    else:
        url = f"https://storage.googleapis.com/gnomad-public/release/{version}/vcf/genomes/gnomad.genomes.r{version}.sites.{chrom}.vcf.bgz"
...
def stream_process_gnomad_lof(chrom='21', version='3.1.2', max_variants=10000):
    ...
    if version.startswith('3'):
        ...
        url = f"https://storage.googleapis.com/gnomad-public/release/{version}/vcf/exomes/gnomad.exomes.r{version}.sites.{chrom}.vcf.bgz"
...
def download_preprocessed_lof():
    ...
    urls = {
        'pLoF_v2': 'https://storage.googleapis.com/gnomad-public/papers/2019-flagship-lof/v1.0/gnomad.v2.1.1.all_lofs.txt.bgz',
        'homozygous_lof': 'https://storage.googleapis.com/gnomad-public/papers/2019-flagship-lof/v1.0/gnomad.v2.1.1.lof_homozygous.txt.bgz'
    }
