...
def query_gnomad_tabix(chrom, start, end, build="hg38"):
    ...
    try:
        ...
        if build == "hg38":
            url = "https://storage.googleapis.com/gcp-public-data--gnomad/release/3.1.2/vcf/genomes/gnomad.genomes.v3.1.2.sites.chr{}.vcf.bgz".format(chrom)
        else:  # hg19/GRCh37
            url = "https://storage.googleapis.com/gcp-public-data--gnomad/release/2.1.1/vcf/genomes/gnomad.genomes.r2.1.1.sites.{}.vcf.bgz".format(chrom)
