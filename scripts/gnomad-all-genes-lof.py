...
def process_gnomad_annotated_files(chromosomes=None):
    ...
    for chrom in chromosomes:
        ...
        url = f"https://storage.googleapis.com/gcp-public-data--gnomad/release/2.1.1/vcf/exomes/gnomad.exomes.r2.1.1.sites.{chrom}.vcf.bgz"
...
def process_single_chromosome(chrom, processor):
    ...
    if processor.version == 'v2.1.1':
        ...
        url = f"https://storage.googleapis.com/gcp-public-data--gnomad/release/3.1.2/vcf/genomes/gnomad.genomes.v3.1.2.sites.chr{chrom}.vcf.bgz"
